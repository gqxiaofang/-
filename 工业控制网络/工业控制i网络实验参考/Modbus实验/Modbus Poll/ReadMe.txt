------------------------------------------------------------------------------------
                       Modbus Poll
         Copyright (c) 2002-2008. Witte Software.
------------------------------------------------------------------------------------
...
tool. Modbus Poll will run on all 32-bit Windows versions
in use today - Windows 2000, XP and Vista.
...
- Data logging to a text file readable by MS Excel.
